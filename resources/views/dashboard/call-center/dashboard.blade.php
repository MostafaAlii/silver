                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                ...
                                <p>
                                    @if(Captain::whereCountryId(get_user_data()->country_id)->whereGender('male')->count()
                                    > 0)
                                    <span
                                        class="badge badge-success">{{Captain::whereCountryId(get_user_data()->country_id)->whereGender('male')?->count()}}</span>
                                    Male Captain -
                                    <span
                                        class="badge badge-primary">{{Captain::whereCountryId(get_user_data()->country_id)->whereGender('female')?->count()}}</span>
                                    Female Captain
                                    @else
